...
{
    private const HEADERS = ['Spesifikasi', 'Kode', 'Nama Produk', 'NIE', 'QTY', 'Kode Golongan', 'Custom'];
    ...
    public function stream(string $filename = 'template-produk.xlsx'): StreamedResponse
    {
        ...
        foreach ($categories as $categoryName) {
            ...
            $sampleRows = [
                ['Contoh Spesifikasi 1', 'SKU-001', 'Nama Produk Contoh 1', '21302420095', 1, '01', 'Tidak'],
                ['Contoh Spesifikasi 2', 'SKU-002', 'Nama Produk Contoh 2', '21302420095', 1, '03', 'Ya'],
            ];
